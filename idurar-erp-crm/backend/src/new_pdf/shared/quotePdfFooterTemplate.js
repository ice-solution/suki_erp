...
function buildStandardQuoteFooterTemplate() {
  ...
  return `
<div style="width:100%; height:100%; box-sizing:border-box; display:flex; flex-direction:column; justify-content:flex-end; padding:0 12px 2px; color:#000; border-top:1px solid #ddd;">
  <div style="font-size:12px; line-height:1.5; margin-bottom:2px; color:#000; text-align:center;">${zh}</div>
  <div style="font-size:12px; line-height:1.5; margin-bottom:2px; color:#000; text-align:center;">${en}</div>
  <div style="font-size:11px; line-height:1.5; color:#000; text-align:right; margin-top:2px;">
